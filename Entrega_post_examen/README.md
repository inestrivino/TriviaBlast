...
* **Tablero de Juego:** Sistema competitivo por turnos sobre un tablero clásico con categorías representadas por colores. Gana el primer jugador en llegar al final del tablero. Existen casillas comodín y un modo "doble o nada". Durante la creación de la partida, se pueden configurar los tipos de preguntas, la dificultad de éstas, y el número de casillas en la partida.
